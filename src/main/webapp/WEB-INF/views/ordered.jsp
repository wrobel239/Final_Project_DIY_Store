...
<head>
    ...
    <title>MWbud - koniec zamówienia</title>
                    ...
                    <div class="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Koniec zamówienia</li>
                            </ul>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row"><!-- shop main wrapper start -->
                <div class="col-lg-12">
                    <div class="shop-product-wrapper"><!-- shop product top wrap start -->
                        <c:if test="${typeOfPayment.equals('CASH_ON_DELIVERY')}">
                            <p>Wybrano płatność przy odbiorze. Dziękujemy za złożone zamówienie</p>
                        </c:if>
                        <c:if test="${typeOfPayment.equals('BANK_TRANSFER')}">
                            <p>Opłacono zamówienie w systemie przelewu bankowego. Dziękujemy za zakupy</p>
                        </c:if>
                        <c:if test="${typeOfPayment.equals('PAYPAL')}">
                            <p>Opłacono zamówienie w systemie PayPal. Dziękujemy za zakupy</p>
                        </c:if>
                        <div class="cart-update"><a href="/index" class="btn btn-sqr">Wróć do strony głównej</a></div>
                    </div>
