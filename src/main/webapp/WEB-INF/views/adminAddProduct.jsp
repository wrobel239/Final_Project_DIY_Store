                                            ...
                                            <div class="myaccount-content"><h5>Dodanie/Edycja produktu</h5>
                                                <div class="account-details-form">
                                                    <form:form method="post" modelAttribute="productPojo">
                                                        ...
                                                        <div class="single-input-item">
                                                            <label for="srcImage">Src zdjęcia</label>
                                                            <form:input path="srcImage" id="srcImage" placeholder="Src zdjęcia"/>
                                                            <form:errors path="srcImage" cssClass="errors"/>
                                                        </div>
                                                        <div class="single-input-item">
                                                            <label for="altImage">Alt zdjęcia</label>
                                                            <form:input path="altImage" id="altImage" placeholder="Alt zdjęcia"/>
                                                            <form:errors path="altImage" cssClass="errors"/>
                                                        </div>
                                                        <div class="single-input-item">
                                                            <label for="availability" class="required">Wybór dostępności</label>
