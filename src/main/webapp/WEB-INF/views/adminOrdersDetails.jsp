...
<head>
    ...
    <title>MWbud - panel admina - zamówienia - detale</title>
                    ...
                    <div class="breadcrumb-wrap">
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Detale</li>
                            </ul>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="col-lg-9 col-md-8">
                                    <div class="tab-content" id="myaccountContent"><!-- Single Tab Content Start -->
                                        <div <%--class="tab-pane fade"--%> id="orders" role="tabpanel">
                                            <div class="myaccount-content"><h5>Detale zamówienia</h5>
                                                <div class="cart-table table-responsive text-center">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="pro-quantity">Ilość</th>
